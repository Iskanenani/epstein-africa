...
export const STORY_COPY = {
  en: {
    ...
    longreadsHeading: "Long reads",
    longreadsSubtitle: "Multi-year syntheses drawn from the atomised stories below.",
  ...
  fr: {
    ...
    longreadsHeading: "Dossiers",
    longreadsSubtitle: "Dossiers pluriannuels tirés des récits atomisés ci-dessous.",
    storiesLabel: "Récits",
...
export const HOME_COPY = {
  ...
  fr: {
    ...
    description:
      "Six dossiers reconstruisant le réseau africain de Jeffrey Epstein, issus des 1,78 million de documents publiés par le DOJ.",
    ogSubtitle: "six dossiers issus de la publication DOJ",
    brand: "Epstein Africa",
    tagline: "Archives primaires",
    metaLeft: "Issu de 1,78 million de documents du DOJ",
    metaRight: "Six dossiers · Archive permanente",
    ...
    sectionHeadLongreads: "Six dossiers",
